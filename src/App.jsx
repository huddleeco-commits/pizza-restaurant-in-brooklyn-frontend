/**
 * Pizza-restaurant-in-Brooklyn - Frontend App
    ...
    <>
      <nav style={styles.nav}>
        <Link to="/" style={styles.navBrand}>
          <span style={styles.brandText}>Pizza restaurant in Brooklyn</span>
        </Link>
      ...
      <div style={styles.app}>
        <NavWrapper>
          ...
          <footer style={styles.footer}>
            <p>© 2026 Pizza-restaurant-in-Brooklyn. All rights reserved.</p>
          </footer>
        </NavWrapper>
      </div>
    </BrowserRouter>
